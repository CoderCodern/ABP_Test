...
namespace TestABP.Migrations
{
    ...
    [Migration("20250527085551_add CloudFolder table")]
    partial class addCloudFoldertable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestABP.Domain.CloudFolders.CloudFolder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TestABP.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TestABP.Authorization.Users.User", null)
                        .WithMany("Claims")
